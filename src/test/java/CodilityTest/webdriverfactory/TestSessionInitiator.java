...
public class TestSessionInitiator {
    ...
    public HomePage pageOne;

    private void _initPage() {
    	pageOne = new HomePage(driver);
    }
    ...
    private void _configureBrowser()  {
        ...
        driver.manage().timeouts().implicitlyWait(Integer.parseInt(ConfigPropertyReader.getProperty("timeout")), TimeUnit.SECONDS);
    }
